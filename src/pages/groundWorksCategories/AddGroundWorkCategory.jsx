...
const AddGroundWorkCategory = () => {
  ...
  const handleAddCategory = async (e) => {
    ...
    categoryFormData.append("categoryType", "groundwork");
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setTimeout(() => navigate("/Groundworkcategories"), 800);
      }
    } catch (error) {
      console.log(error);
    }
...
export default AddGroundWorkCategory;
