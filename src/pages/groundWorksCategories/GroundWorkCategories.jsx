...
const Categories = () => {
  ...
  //   Get categories?type:tools
  //   Post categories
  //   body-->
  //   title
  //   description
  //   categoryType:[tools,groundwork]
  //   icon
  ...
  return (
    <Container
      addButton={true}
      addButtonLink={"/addGroundWorkCategory"}
      addButtonText={"+ Add More"}
      // isLoading={loading}
      // error={error}
    >
      <div className="flex justify-between flex-wrap">
        <SectionTitle>Groundwork Category:</SectionTitle>
        <input
          type="text"
          value={filterTerm}
        ...
        <div className=" flex flex-col gap-3">
          {categories.length === 0 ? (
            ...
            categories.map((category) => (
              <div
                key={category._id}
                className="flex items-center rounded-lg bg-[#E5ECE7] shadow-lg justify-between px-5 py-4"
              >
