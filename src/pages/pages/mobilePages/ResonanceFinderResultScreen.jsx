...
import resonanceFinderResult from "./screenImages/resonanceFinderResult.png";
import { FiCamera } from "react-icons/fi";
const ResonanceFinderResultScreen = () => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <div className="m-10">
          <Box
            ...
            center="center"
            div={
              <div className="flex flex-col bg-[] justify-center items-center -mt-5 space-y-5 -ml-5  w-[100%]">
                ...
                <div className="w-[200px] h-[60px] bg-[#E5ECE7] rounded-lg mt-5 flex justify-center items-center">
                  <p className="text-[gray]">You're Star!</p>
                </div>
                <div className="w-[420px] h-[130px] bg-[#E5ECE7] rounded-lg mt-5 flex justify-center items-center">
                ...
                <div className="w-[200px] h-[60px] bg-[#E5ECE7] rounded-lg mt-5 flex justify-center items-center">
                  <p className="text-[gray]">With gratitude!</p>
                </div>
              </div>
            }
          />
...
export default ResonanceFinderResultScreen;
