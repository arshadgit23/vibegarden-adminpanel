...
import garden from  "./screenImages/garden.png"
...
const GardenScreen = () => {
    ...
    return (
        <>
            ...
            <MobileScreenHeader heading="Garden Screen"
                ...
                <div className='m-10'>
                    <Box heading="Sub Header"
                      absoluteDiv={
                        ...
                        inputBtn={<input type="text" placeholder='Hi, You' className='border-none outline-none' />} />
                </div>
                <div>
                    <h1 className="text-[#1C5C2E] text-[24px]">Preview:</h1>
                    <div className="w-[300px] h-[550px] flex flex-col  rounded-[40px] mt-10">
                        <img src={garden} alt="mobileImg" className="rounded" width={'100%'} height={'100%'} />
                    </div>
                </div>
