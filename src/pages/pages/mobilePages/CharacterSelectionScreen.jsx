...
import characterSelection from "./screenImages/characterSelection.png"
...
const CharacterSelectionScreen = () => {
    ...
    return (
        <>
            ...
            <MobileScreenHeader heading="Character Selection Screen"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                <div className='m-10 space-y-10'>
                    <Box
                     absoluteDiv={
                        ...
                        description="Which of these resonance must? "
                    />
                    <Box
                     absoluteDiv={
                        <div className='w-[150px] h-[50px] bg-[white]  rounded-[25px] absolute -top-6 left-3 flex justify-center items-center '>
                            <p className='font-semibold '>Meet Avatar text</p>
                        </div>
                    }
                        heading=" Meet Avatar text"
                ...
                <div>
                    ...
                    <div className="w-[300px] h-[550px] flex flex-col rounded-[40px] mt-10">
                        <img src={characterSelection} alt="mobileImg" className="rounded-[40px] relative" width={'100%'} height={'100%'} />
                    </div>
                </div>
            </div>
        </>
