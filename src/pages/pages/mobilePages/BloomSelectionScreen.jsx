...
import bloomSelection from "./screenImages/bloomSelection.png"


const BloomSelectionScreen = () => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                <div className='m-10 space-y-10'>
                    ...
                    <Box
                     absoluteDiv={
                        <div className='w-[140px] h-[50px] bg-[white]  rounded-[25px] absolute -top-6 left-3 flex justify-center items-center '>
                            <p className='font-semibold '>Meet Bloooms text</p>
                        </div>
                    }
                        heading=" Meet Blooms text"
                ...
                <div>
                    ...
                    <div className="w-[300px] h-[550px] flex flex-col  rounded-[40px] mt-10">
                        <img src={bloomSelection} alt="mobileImg" className="rounded-[40px] relative" width={'100%'} height={'100%'} />
                    </div>
                </div>
            </div>
        </>
...
export default BloomSelectionScreen