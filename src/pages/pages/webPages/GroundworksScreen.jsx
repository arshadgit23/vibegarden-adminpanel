...
const GroundworksScreen = () => {
    ...
    return (
        <>
            ...
            <MobileScreenHeader heading="Groundworks"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                <div className='m-10 space-y-10'>
                    ...
                    <Box
                        absoluteDiv={
                            <div className='w-[120px] h-[50px] bg-[white]  rounded-[25px] absolute -top-6 left-3 flex justify-center items-center '>
                                <p className='font-semibold '>Building Slock</p>
                            </div>
                        }
                        subHeading="Lorem ipsum dolor sit"
                        line={
                    ...
                    <Box
                        absoluteDiv={
                            <div className='w-[80px] h-[50px] bg-[white]  rounded-[25px] absolute -top-6 left-3 flex justify-center items-center '>
                                <p className='font-semibold '>Deeper Cut</p>
                            </div>
                        }
                        subHeading="Lorem ipsum dolor sit"
                        line={
                    ...
                    />    <Box
                        absoluteDiv={
                            <div className='w-[50px] h-[50px] bg-[white]  rounded-[25px] absolute -top-6 left-3 flex justify-center items-center '>
