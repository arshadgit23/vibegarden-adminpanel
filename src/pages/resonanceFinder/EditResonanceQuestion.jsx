...
const EditResonanceQuestion = () => {
  ...
  const [questionThatShouldBeEdit] = questions?.filter(
  ...
  useEffect(() => {
    setInputs((prev) => ({
      ...prev,
      statement: questionThatShouldBeEdit?.statement,
      ans1: questionThatShouldBeEdit?.answer1,
      ans2: questionThatShouldBeEdit?.answer2,
      ans3: questionThatShouldBeEdit?.answer3,
      ans4: questionThatShouldBeEdit?.answer4,
      percentage1: questionThatShouldBeEdit?.answer1Value,
      percentage2: questionThatShouldBeEdit?.answer2Value,
      percentage3: questionThatShouldBeEdit?.answer3Value,
      percentage4: questionThatShouldBeEdit?.answer4Value,
    }));
  }, [questionThatShouldBeEdit]);
...
export default EditResonanceQuestion;
