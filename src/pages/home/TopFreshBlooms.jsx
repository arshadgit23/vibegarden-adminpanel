...
const TopFreshBlooms = ({ data }) => {
  ...
  return (
    <div className="ml-10">
      <div className="bg-[white] w-[100%] h-[785px] rounded-[20px] shadow-lg shadow-[#00000029]-500/50 overflow-y-auto">
