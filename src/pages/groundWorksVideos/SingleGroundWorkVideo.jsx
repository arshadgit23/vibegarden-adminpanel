...
import VideoDetail from "../feedBackSystem/VideoDetail";

const SingleGroundWorkVideo = (props) => {
  const { id } = useParams();
      ...
      <div>
        <div className=" flex justify-between items-center">
          ...
          <div className=" relative flex gap-3 items-center">
            ...
            />
            <a href={`/UpdateGroundworkVideo/${id}`}>
              <Button
                text="Edit"
                bgColor="#55C595"
                color="#fff"
        ...
        <div className="h-96 flex justify-start items-start my-12">
          <div className=" w-2/5 h-full">
            <Video
              data={data?.data?.data}
              className="relative w-100 h-[35vh]"
            />
          </div>
...
export default SingleGroundWorkVideo;
